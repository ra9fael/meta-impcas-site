...
# Configure networking and time sync from /boot/machine/machine.cfg (a plain
# KEY=value file on the writable BOOT partition, edited per machine before
# first boot).
...
#
# With no /boot/machine/machine.cfg the service exits and the built-in networkd
# configuration applies unchanged.

set -e

CFG=/boot/machine/machine.cfg
